...
const students = [
  ...
  { name: 'Maggie Xu', topic: 'The Effect of Blue Light on Myopia Progression in Young Smartphone Users', category: 'Current PhD' },
  ...
  { name: 'Dr Safal Khanal', topic: 'The effect of changes in choroidal perfusion on visual function', category: 'PhD Alumni' },
