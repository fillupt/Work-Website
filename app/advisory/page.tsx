  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Advisory & Consulting</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Regulatory Advisory</h3>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Civil Aviation Authority</h3>
            <div className="space-y-3 text-gray-700">
              <p>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Expert Witness</h3>
            <div className="space-y-3 text-gray-700">
              <p>
